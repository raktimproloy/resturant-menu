        ...
        {cards.map((card) => {
          ...
          return (
            <Link
              key={card.href}
              href={card.href}
              className="bg-gray-800 rounded-xl p-6 hover:bg-gray-750 transition-colors border border-gray-700 hover:border-gray-600"
            >
              ...
              <p className="text-3xl font-bold text-indigo-400">{card.count}</p>
            </Link>
          );
        })}
      </div>
